...
class TeamPassingDefenseESPNSpider(scrapy.Spider):
    """Pulls all of the historical team passing data"""
    name = 'team-passing-defense-espn'
    start_urls = ['https://www.espn.com/nfl/stats/team/_/view/defense/stat/passing/table/passing']
    custom_settings = {
    ...
    def parse(self, response):
        ...
        for value in response.xpath(query).getall():
            ...
            season = parts[0]
            season_type = parts[1]
            # https://www.espn.com/nfl/stats/team/_/view/defense/stat/passing/season/2020/seasontype/2/table/passing/sort/sacks/dir/desc
            passing_stats_url = f"https://www.espn.com/nfl/stats/team/_/view/defense/stat/passing/season/{season}/seasontype/{season_type}/table/passing"
